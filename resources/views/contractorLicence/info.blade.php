            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Contractor Information')}}</h1>
                    </div>
                    </div>
                </div><!-- /.container-fluid -->
        </section>
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 pt-2">
                                            {{ ucfirst($data->subCategories->fees) }}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('contractorLicence.edit', $data->slug) }}"
                                       class="btn btn-primary"><i class="fas fa-highlighter"></i>&nbsp;
                                    {{__('Update')}}</a>

                                    <a href="{{ route('contractorLicence.delete', $data->slug) }}" class="btn btn-danger"><i
