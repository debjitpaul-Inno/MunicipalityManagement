            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Contractor List')}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ route('contractorLicence.create') }}" class="btn btn-success float-right"><i
                                class="fas fa-plus"></i>&nbsp;
                            {{__('Add')}}</a>
                    </div>
                </div>
...
{{--                                        @if($item->subCategories()->exists())--}}
                                            <tr>
                                                ...
                                                <td>{{ ucwords($item->applicant_name) }}</td>
                                                <td>{{ ucwords($item->business_phone) }}</td>
                                                <td>{{getWordWithSpace( ucwords($item->application_type)) }}</td>
