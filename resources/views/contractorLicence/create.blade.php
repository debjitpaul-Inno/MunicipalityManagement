            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Create New Contractor')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="createForm" action="{{route('contractorLicence.store')}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="enlistment_no" name="enlistment_no"
                                                   value="{{ old('enlistment_no') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control " id="constitution_date" name="constitution_date"
                                                   value="{{ old('constitution_date') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" name="business_address_street" id="business_address_street"
                                                      class="form-control" required>{{ old('business_address_street') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="business_address_post_office" name="business_address_post_office"
                                                   value="{{ old('business_address_post_office') }}" required>
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control select2"  name="business_address_district_id" id="business_address_district_id" style="width: 100%" required>
                                                ...
                                                @foreach($locations as $item)
                                                    <option
                                                        value="{{ $item->id }}" {{$item->business_address_district_id == $item->id}} >{{ucwords($item->name)}}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="business_address_post_code" name="business_address_post_code"
                                                   value="{{ old('business_address_post_code') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="vat_reg_no"
                                                   name="vat_reg_no" value="{{ old('vat_reg_no') }}"
                                                   required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="managing_director_name" name="managing_director_name"
                                                   value="{{ old('managing_director_name') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="education_qualification" name="education_qualification"
                                                   value="{{ old('education_qualification') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="personal_phone_number" name="personal_phone_number"
                                                   value="{{ old('personal_phone_number') }}" required>
...
{{--                                    <div class="form-group row">--}}
{{--                                        <label for="fees" class="col-sm-3 col-form-label">{{__('Fees')}}</label>--}}
{{--                                        <div class="col-sm-6">--}}
...
{{--                                    </div>--}}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="technical_employee" name="technical_employee"
                                                   value="{{ old('technical_employee') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="support_staff" name="support_staff"
                                                   value="{{ old('support_staff') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="other_staff" name="other_staff"
                                                   value="{{ old('other_staff') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="financial_source" name="financial_source"
                                                   value="{{ old('financial_source') }}" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="file" class="col-sm-3 col-form-label"><span>*</span>{{__('Upload Documents *')}}</label>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button type="submit" class="btn btn-success"><i class="fas fa-plus-circle"></i>&nbsp;{{__('Save')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
