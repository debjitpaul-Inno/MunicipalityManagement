                        ...
                        <div class="card card-primary">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label id="designation" class="col-sm-3 col-form-label">{{__('Designation')}}
                                            :</label>
                                        <div class="col-sm-9 pt-2">
                                    ...
                                    <div class="form-group row">
                                        <label id="job_type" class="col-sm-3 col-form-label">{{__('Job Type')}}
                                            :</label>
                                        <div class="col-sm-9 pt-2">
                                    ...
                                    <div class="form-group row">
                                        <label id="join_date" class="col-sm-3 col-form-label">{{__('Join Date')}}
                                            :</label>
                                        <div class="col-sm-9 pt-2">
