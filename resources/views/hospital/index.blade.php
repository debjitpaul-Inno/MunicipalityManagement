            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Hospital List')}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ route('hospital.create') }}" class="btn btn-success float-right"><i
                                class="fas fa-plus"></i>&nbsp;
                            {{__('Add')}}</a>
                    </div>
                </div>
                <form id="search_box" style="width:100%" action="{{ route('hospital.index') }}" method="GET">
                        ...
                        <div class="col-8 col-sm-9 col-md-10">
                            <div class="input-group">
                                ...
                                <label for="search"></label><input type="search" id="search" name="search"
                                                                   ...
                                                                   placeholder="{{__('Search By Hospital Name')}}">

                            </div>
                        </div>
                        <div class="col-4 col-sm-3 col-md-2">
                            <a href="{{ route('hospital.index') }}" type="button" class="btn btn-danger"
                               style="width: 100%">
                                        ...
                                        @if($item->wards()->exists())
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('hospital.show', $item->slug)}}"
                                                       class="btn btn-info mb-2"><i
                                                            class="fas fa-info"></i>&nbsp; {{__('Info')}}</a>

                                                    <a href="{{ route('hospital.edit', $item->slug) }}"
                                                       class="btn btn-primary mb-2"><i class="fas fa-edit"></i>&nbsp;
                                                        {{__('Edit')}}</a>

                                                    <a href="{{ route('hospital.delete', $item->slug) }}"
