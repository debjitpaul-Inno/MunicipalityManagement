            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Update Education Institution Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="editForm" action="{{route('educationInstitution.update', $data->slug)}}"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="institution_category"
                                               class="col-sm-3 col-form-label"><span>*</span>{{__('Institution Category')}}</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" name="institution_category"
                                                    id="institution_category"
                                                    required>
                                                <option
                                                    value="Government" {{$data->institution_category == "Government" ? 'selected':''}}>
                                                    Government
                                                </option>
                                                <option
                                                    value="Private" {{$data->institution_category == "Private" ? 'selected':''}}>
                                                    Private
                                                </option>
                                    ...
                                    <div class="form-group row">
                                        <label for="institution_type"
                                               class="col-sm-3 col-form-label"><span>*</span>{{__('Institution Type')}}</label>
                                        <div class="col-sm-6">
                                            <select class="form-control" name="institution_type" id="institution_type"
                                                    required>
                                                {{--                                                <option hidden></option>--}}
                                                <option
                                                    value="primary_school" {{$data->institution_type == "Primary School" ? 'selected':''}}>
                                                    Primary School
                                                </option>
                                                <option
                                                    value="high_school" {{$data->institution_type == "High School" ? 'selected':''}}>
                                                    High School
                                                </option>
                                                <option
                                                    value="college" {{$data->institution_type == "College" ? 'selected':''}}>
                                                    College
                                                </option>
                                                <option
                                                    value="madrasa" {{$data->institution_type == "Madrasa" ? 'selected':''}}>
                                                    Madrasa
                                                </option>
                                                <option
                                                    value="university" {{$data->institution_type == "University" ? 'selected':''}}>
                                                    University
                                                </option>
                                    ...
                                    <div class="form-group row">
                                        <label for="name"
                                               class="col-sm-3 col-form-label"><span>*</span>{{__('Institution Name')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="code"
                                               class="col-sm-3 col-form-label"><span>*</span>{{__('Institution Code')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="principle_name"
                                               class="col-sm-3 col-form-label"><span>*</span>{{__('Institution Head')}}</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="principle_name"
                                                   name="principle_name"
                                                   value="{{ old('principle_name', $data->principle_name) }}"
                                                   required>
