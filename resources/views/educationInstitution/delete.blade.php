            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Delete Education Institution Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="dltForm"
                                  action="{{ route('educationInstitution.destroy', $data->slug) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 pt-2">
                                            {{ ucwords( \Str::camel($data->institution_type) ) }}
                                        </div>
                                    </div>
                                    <div class="form-group row">
