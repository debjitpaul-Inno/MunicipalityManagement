            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Character Certificate Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                        ...
                        <div class="card card-primary">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label id="people_id" class="col-sm-3 col-form-label">{{__('Ward')}} :</label>
                                        <div class="col-sm-9 pt-2">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('characterCertificate.edit', $data->slug) }}"
                                       class="btn btn-primary"><i class="fas fa-highlighter"></i>&nbsp;
                                    {{__('Update')}}</a>

                                    <a href="{{ route('characterCertificate.delete', $data->slug) }}" class="btn btn-danger"><i
