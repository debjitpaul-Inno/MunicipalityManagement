            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Update Public Toilet Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="editForm" action="{{route('publicToilet.update', $data->slug)}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="public_toilet_number"
                                                   ...
                                                   value="{{ old('public_toilet_number', $data->public_toilet_number) }}"
                                                   required>
                                            @if ($errors->has('public_toilet_number'))
                                                <span
                                                    class="text-danger">{{ $errors->first('public_toilet_number') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="code"
                                                   ...
                                                   value="{{ old('maintain_people_name', $data->maintain_people_name) }}"
                                                   required>
                                            @if ($errors->has('maintain_people_name'))
                                                <span
                                                    class="text-danger">{{ $errors->first('maintain_people_name') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="form-group row">
