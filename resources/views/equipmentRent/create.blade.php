                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="createForm" action="{{route('equipmentRent.store')}}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="equipment_number" name="equipment_number"
                                                   value="{{ old('equipment_number') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="rental_period" name="rental_period"
                                                   value="{{ old('rental_period') }}" placeholder="In Hours" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="rental_cost" name="rental_cost"
                                                   value="{{ old('rental_cost') }}" required>
