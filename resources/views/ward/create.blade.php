                            ...
                            <form role="form" id="createForm" action="{{route('ward.store')}}" class="form-horizontal clearfix"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" id="name" class="col-sm-3 col-form-label"><span> *</span>{{__('Ward Name')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="number" id="number" class="col-sm-3 col-form-label"><span> *</span>{{__('Ward Number')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="area" id="area" class="col-sm-3 col-form-label"><span> *</span>{{__('Ward Area')}}</label>
                                        <div class="col-sm-6">
