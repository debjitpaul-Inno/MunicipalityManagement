            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Update Tender Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="editForm" action="{{route('tender.update', $data->slug)}}"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control select2" name="ministry_id" id="ministry_id"
                                                    required>
                                                <option hidden value="{{ old('ministry_id', $data->ministry_id) }}">{{$data->ministries->name}}</option>
                                                @foreach($ministries as $item)
                                                    <option
                                                        value="{{ $item->id }}" {{$item->ministry_id == $item->id ? 'selected' : ''}}>{{ucwords($item->name)}}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="entity_name" name="entity_name"
                                                   value="{{ old('entity_name', $data->entity_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="entity_code" name="entity_code"
                                                   value="{{ old('entity_code',  $data->entity_code) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control" name="invitation_for" id="invitation_for" required>
                                                ...
                                                <option value="work" {{$data->invitation_for == "work" ? 'selected':''}}>Work</option>
                                                <option value="goods" {{$data->invitation_for == "goods" ? 'selected':''}}>Goods</option>
                                                <option value="product" {{$data->invitation_for == "product" ? 'selected':''}}>Product</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control" id="submission_date" name="submission_date"
                                                   value="{{ old('submission_date', $data->submission_date) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="budget" name="budget"
                                                   value="{{ old('budget', $data->budget) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="development_partner" name="development_partner"
                                                   value="{{ old('development_partner', $data->development_partner) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="package_name" name="package_name"
                                                   value="{{ old('package_name', $data->package_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="package_no" name="package_no"
                                                   value="{{ old('package_no', $data->package_no) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="programme_name" id="programme_name"
                                                   class="form-control" value="{{ old('programme_name', $data->programme_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="programme_code" id="programme_code"
                                                   class="form-control" value="{{ old('programme_code', $data->programme_code) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control take_past_date" id="last_selling_date" name="last_selling_date"
                                                   value="{{ old('last_selling_date', $data->last_selling_date) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="datetime-local" class="form-control" id="closing_date" name="closing_date"
                                                   value="{{ old('closing_date',date('Y-m-d\TH:i', strtotime($data->closing_date)) ) }}" required >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="datetime-local" class="form-control" id="opening_date" name="opening_date"
                                                   value="{{ old('opening_date',date('Y-m-d\TH:i', strtotime($data->opening_date)) ) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="principle_selling_document" name="principle_selling_document" required>{{ old('principle_selling_document',$data->principle_selling_document) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="receiving_document" name="receiving_document" required>{{ old('receiving_document', $data->receiving_document) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="opening_document" name="opening_document" required>{{ old('opening_document', $data->opening_document) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="other_selling_document"
                                                      name="other_selling_document" required>{{ old('other_selling_document', $data->other_selling_document) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="meeting_place" name="meeting_place">{{ old('meeting_place', $data->meeting_place) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="datetime-local" class="form-control take_past_date" id="meeting_date" name="meeting_date"
                                                   value="{{ old('meeting_date',date('Y-m-d\TH:i', strtotime($data->meeting_date))) }}" required >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="eligibility" name="eligibility"
                                                      required>{{ old('eligibility', $data->eligibility) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="description_goods" name="description_goods"
                                                      required>{{ old('description_goods', $data->description_goods) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="description_related_service" name="description_related_service"
                                                      required>{{ old('description_related_service', $data->description_related_service) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="document_price" name="document_price"
                                                   value="{{ old('document_price',$data->document_price) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="lot_no" name="lot_no"
                                                   value="{{ old('lot_no', $data->lot_no) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="identification" name="identification"
                                                      required>{{ old('identification', $data->identification) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="location" name="location"
                                                      required>{{ old('location', $data->location) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="security_amount" name="security_amount"
                                                   value="{{ old('security_amount',$data->security_amount) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="completion" name="completion"
                                                   value="{{ old('completion',$data->completion) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="official_inviting_name" name="official_inviting_name"
                                                   value="{{ old('official_inviting_name', $data->official_inviting_name) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="official_inviting_designation" name="official_inviting_designation"
                                                   value="{{ old('official_inviting_designation', $data->official_inviting_designation) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea type="text" class="form-control" id="official_inviting_address" name="official_inviting_address"  required>{{ old('official_inviting_address', $data->official_inviting_address) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="official_inviting_contact_phone" name="official_inviting_contact_phone" value="{{ old('official_inviting_contact_phone',$data->official_inviting_contact_phone) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="official_inviting_contact_fax" name="official_inviting_contact_fax"
                                                   value="{{ old('official_inviting_contact_fax',$data->official_inviting_contact_fax) }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="email" class="form-control" id="official_inviting_contact_email" name="official_inviting_contact_email"
                                                   value="{{ old('official_inviting_contact_email', $data->official_inviting_contact_email) }}" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="file" class="col-sm-3 col-form-label">{{__('Update Documents')}}</label>
...
@push('customScripts')
    ...
    <script>
        ...
        $(function (){
            ...
            var tender_doc_array = {!! json_encode($data->tenderDocuments->toArray() ) !!}
            console.log("Tender Document Id" )
            console.log(tender_doc_array)

            for(var i=0; i<tender_doc_array.length; i++)
            {
                doc_id_array.push(tender_doc_array[i].id)
            }
