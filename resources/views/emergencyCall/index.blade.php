            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Emergency Call List')}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ route('emergencyCall.create') }}" class="btn btn-success float-right"><i
                                class="fas fa-plus"></i>&nbsp;
                            {{__('Add')}}</a>
                    </div>
                </div>
                <form id="search_box" style="width:100%" action="{{ route('emergencyCall.index') }}" method="GET">
                        ...
                        <div class="col-8 col-sm-9 col-md-10">
                            <div class="input-group">
                                ...
                                <label for="search"></label><input type="search" id="search" name="search"
                                                                   ...
                                                                   placeholder="{{__('Search By Caller Name')}}">

                            </div>
                        </div>
                        <div class="col-4 col-sm-3 col-md-2">
                            <a href="{{ route('emergencyCall.index') }}" type="button" class="btn btn-danger"
                               style="width: 100%">
                            ...
                            <div class="card-body">
                                <table id="indexTable" class="table table-bordered table-striped">
                                    ...
                                    <tr class="text-center">
                                        <th>{{__('SL')}}</th>
                                        <th>{{__('Name Of Caller')}}</th>
                                        <th>{{__('Phone Number')}}</th>
                                        <th>{{__('Call Details')}}</th>
                                        <th>{{__('Date Of Call')}}</th>
                                        <th>{{__('Status')}}</th>
