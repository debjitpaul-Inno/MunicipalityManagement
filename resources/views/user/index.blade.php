    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="container-fluid">
                ...
                <form id="search_box" style="width:100%" action="{{ route('employee.index') }}" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-sm-3 col-md-2">
                            <a href="{{ route('employee.index') }}" type="button" class="btn btn-danger"
                               style="width: 100%">
                                    ...
                                    @foreach($contentData as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('employee.edit', $item->slug) }}"
