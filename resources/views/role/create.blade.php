                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="createForm" action="{{route('role.store')}}" class="form-horizontal clearfix"
                                  method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" id="name" class="col-sm-3 col-form-label"><span> *</span>{{__('Role Name')}}</label>
                                        <div class="col-sm-6">
