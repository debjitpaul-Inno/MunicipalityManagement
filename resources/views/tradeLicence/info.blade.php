            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Trade Licence Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                        ...
                        <div class="card card-primary">
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label id="issue_date" class="col-sm-6 col-md-3 col-form-label">{{__('Licence Issue Date')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->issue_date) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="expiry_date" class="col-sm-6 col-md-3 col-form-label">{{__('Licence Expiry Date')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <a href="{{ route('tradeLicence.edit', $data->slug) }}"
                                       class="btn btn-primary"><i class="fas fa-highlighter"></i>&nbsp;
                                    {{__('Update')}}</a>
                                    <a href="{{ route('tradeLicence.delete', $data->slug) }}" class="btn btn-danger"><i
