            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Delete Trade Licence Information')}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="dltForm" action="{{ route('tradeLicence.destroy', $data->slug) }}" class="form-horizontal clearfix"
                                  method="POST"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label id="sub_category_id" class="col-sm-6 col-md-3 col-form-label">{{__('Business Category')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->subcategories->licence_fees) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label id="present_division" class="col-sm-6 col-md-3 col-form-label">{{__('Division')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->presentDivisions->name) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="present_district" class="col-sm-6 col-md-3 col-form-label">{{__('District')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->presentDistricts->name) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="present_thana" class="col-sm-6 col-md-3 col-form-label">{{__('Thana')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                            ...
                                            <div class="form-group row">
                                                <label id="permanent_division" class="col-sm-6 col-md-3 col-form-label">{{__('Division')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->permanentDivisions->name) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="permanent_district" class="col-sm-6 col-md-3 col-form-label">{{__('District')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                                    {{ ucfirst($data->permanentDistricts->name) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="permanent_thana" class="col-sm-6 col-md-3 col-form-label">{{__('Thana')}} :</label>
                                                <div class="col-sm-6 col-md-9 pt-2">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{asset("/storage/".$data->photo)}}" class="img-thumbnail float-right" width="100%"  >
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
