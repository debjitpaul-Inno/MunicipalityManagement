            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Create Equipment Category')}}</h1>
                    </div>
                </div><!-- /.container-fluid -->
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <form role="form" id="createForm" action="{{route('equipmentCategory.store')}}" class="form-horizontal clearfix"
                                  method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" id="name" class="col-sm-3 col-form-label">{{_('Equipment Category Name')}} </label>
                                        <div class="col-sm-6">
