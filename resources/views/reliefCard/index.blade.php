            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="font-family: 'Comfortaa'">
                        <h1>{{__('Relief Card List')}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ route('reliefCard.create') }}" class="btn btn-success float-right"><i
                                class="fas fa-plus"></i>&nbsp;
                            {{__('Add')}}</a>
                    </div>
                </div>
                <form id="search_box" style="width:100%" action="{{ route('reliefCard.index') }}" method="GET">
                        ...
                        <div class="col-8 col-sm-9 col-md-10">
                            <div class="input-group">
                                ...
                                <label for="search"></label><input type="search" id="search" name="search"
                                                                   ...
                                                                   placeholder="{{__('Search By Card Number')}}">

                            </div>
                        </div>
                        <div class="col-4 col-sm-3 col-md-2">
                            <a href="{{ route('reliefCard.index') }}" type="button" class="btn btn-danger"
                               style="width: 100%">
